...
{
  func displaySomething(viewModel: UserTodoList.Something.ViewModel)
}

class UserTodoListViewController: UIViewController, UserTodoListDisplayLogic
{
  ...
  func doSomething()
  {
    let request = UserTodoList.Something.Request()
